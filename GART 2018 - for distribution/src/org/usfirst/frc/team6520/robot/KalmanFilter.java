...
public class KalmanFilter {
	/*
	 * Bộ lọc Kalman, dùng để lọc các giá trị nhiễu trong chuỗi giá trị được gửi về liên tục từ cảm biến.
	 * Thường dùng với những cảm biến độ nhiễu cao như cảm biến siêu âm.
	 * Không cần hiểu, và không bắt buộc phải dùng.
	 */
